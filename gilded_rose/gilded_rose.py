class GildedRose(object):
    ...
    def decrease_quality_based_on_quality_limit(self, item_quality, quality_limit):
        dec = 0
        if item_quality > quality_limit:
            dec = 1
        return dec

    def decrease_quality_based_on_quality_and_sell_in_limits(self, item_quality, quality_limit, item_sell_in, sell_in_limit):
        dec = 0
